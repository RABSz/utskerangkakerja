...
public function index(Request $request)
{
    ...
    $juals = Jual::whereRaw("(kurir_id=0 OR kurir_id=?) AND konsumen_rate=0 AND waktu_pesan>?",
     [auth()->user()->id, date('Y-m-d')]) ->whereIn('status_jual', $this->_arr_status_jual_map[$status_jual])->paginate();
